...
#: Session modes that no longer exist. A slot persisted under one of these comes
#: back as a PLAIN chat: the transcript is untouched and still renders, only the
#: mode-specific dispatch it used to get is gone with the mode itself.
#:
