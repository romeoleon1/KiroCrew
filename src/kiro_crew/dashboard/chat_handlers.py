...
async def api_chat_slot_create(request: web.Request) -> web.Response:
    ...
    # the crew the user picked (finding F3). Refused here, alongside the other
    # pre-peer validations above, so a rejected mode never costs the user an
    # orphaned ``create_peer_slot`` session.
