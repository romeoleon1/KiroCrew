...
from kiro_crew.github_runner import SetupError, run_gh
from kiro_crew.monitoring.models import (
    MAX_MONITOR_CHECK_IDENTITIES_PER_BUCKET,
    MAX_MONITOR_CHECK_IDENTITY_CHARS,
    ProviderErrorKind,
)
from kiro_crew.monitoring.provider_cli import audit_provider_cli_denied, resolve_provider_cli
...
def _resolve_monitor_gh() -> str:
    """Resolve gh with the same protected-chain policy as every monitor CLI."""
    return resolve_provider_cli("gh")
...
class GitHubPullRequestProvider:
    ...
    def __init__(
        self,
        *,
        resolver: GitHubResolver = _resolve_monitor_gh,
