...
import { ArrowLeft, Check, Circle, Clock, ExternalLink, Goal, MessageCircleQuestionMark, Pause, Pencil, Star, UserPlus, Users, Webhook, Zap } from 'lucide-react'
...
export default function MembersPage() {
  ...
  const signalsOf = useCallback(
    ...
    [slotKeyOf, isRunning, liveNeedsYou, isUnread, patrolBadgeOf],
  )
  const sortedMembers = useMemo(
    () => filterRoster(members, rosterFilterQuery, signalsOf),
    [members, rosterFilterQuery, signalsOf],
  )
