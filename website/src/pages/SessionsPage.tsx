...
export default function SessionsPage() {
  ...
  const onNew = async () => {
    ...
    try {
      ...
      // below the header owns the failed state. The notification stays for
      // ChatPage parity but is no longer the only report.
      ...
      dispatch(addNotification({
        ...
        body: i18nT('pages.sessionsPage.new_session_failed', { error: detail }),
      }))
    } finally {
      setCreating(false)
    }
