...
export function ThemeLoaderFrame({ src }: { src: string }) {
  return (
    <iframe
      ...
      aria-hidden="true"
      tabIndex={-1}
      // Opaque-origin sandbox means document.referrer is the only parent datum a
      // loader script can read; no-referrer empties it so a malicious pack cannot
      // exfiltrate the active chat URL (session id) by self-navigating out.
